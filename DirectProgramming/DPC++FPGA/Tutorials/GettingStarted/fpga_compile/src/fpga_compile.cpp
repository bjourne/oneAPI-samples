...
// Forward declare the kernel name in the global scope to reduce name
// mangling.  This is an FPGA best practice that makes it easier to
// identify the kernel in the optimization reports.
...
int main() {
    ...
    // Both runtime and compile time selection necessary.
    ...
    try {
        ...
        // Create a queue bound to the chosen device.  If the device
        // is unavailable, a SYCL runtime exception is thrown.
